...
cardapio.metodos ={
    ...
    adicionarAoCarrinho: (id) =>{
        ...
        if(qntdAtual > 0){
            ...
            if(item.length > 0){
                ...
                //Validar se já possui mesmo item no carrinho
    ...
    finalizarPedido: () =>{
        ...
        if(MEU_CARRINHO.length > 0 && MEU_ENDERECO != null){
            ...
            texto += `\n\n*Valor total (com entrega): R$ ${(VALOR_CARRINHO + VALOR_ENTREGA).toFixed(2).replace('.', ',')}*`;
